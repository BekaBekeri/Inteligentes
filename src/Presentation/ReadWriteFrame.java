...
/******************************************************************************************************************************
 * Class name: ReadWriteFrame Class Description: class encharged of managing the
 * interaction with the user with everything related to read and write files
 *
 *****************************************************************************************************************************/
public class ReadWriteFrame {
	...
	/********************************************************************************************************
	 * Method name: getFileName Method description: method encharged of asking the
	 * user for the name of the file to be read
	 * 
	...
	/*********************************************************************************************************
	 * Method name: readFile Method description: method encharged of calling the
	 * read method of Control, in the Domain package
	 * 
	 * @param filename:
	...
	/***********************************************************************************************************
	 * Method name: writeFile Method description: method encharged of calling
	 * Control, in Domain package, to write information to a file
	 * 
	 * @param filename:
